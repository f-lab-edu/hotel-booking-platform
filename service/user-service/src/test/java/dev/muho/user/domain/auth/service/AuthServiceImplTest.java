...
class AuthServiceImplTest {
    ...
    void login_success() {
        ...
        AuthResult res = authService.login(req);
    ...
    void login_noUser() {
        ...
        assertThatThrownBy(() -> authService.login(req)).isInstanceOf(AuthenticationFailedException.class);
    }
    ...
    void refresh_success() {
        ...
        AuthResult res = authService.refresh(req);
    ...
    void refresh_tokenNotFound() {
        ...
        assertThatThrownBy(() -> authService.refresh(req)).isInstanceOf(AuthenticationFailedException.class);
    }
    ...
    void logout_blankToken() {
        TokenRefreshRequest req = TokenRefreshRequest.builder().refreshToken("").build();
    ...
    void logout_success() {
        TokenRefreshRequest req = TokenRefreshRequest.builder().refreshToken("to-revoke").build();
        authService.logout(req);
